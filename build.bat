...
java -jar ..\RemoveXML.jar a d:\git-repos\norwegian-helipads\PackageSources\scenery\helipads.xml d:\git-repos\norwegian-helipads\PackageSources\scenery\helipads_noconflicts.xml 68.77 67.65 60.76 58.16 59.52 59.74 60.379 60.373 10.37 10.71 10.98 \"5.35 \"5.34 \"5.31 \"6.31
